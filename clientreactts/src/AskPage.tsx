...
export const AskPage = () => {
  const [susccessfullysubmitted, setSusccessfullysubmitted] = React.useState(
    false,
  );
  ...
  const submitForm = async (data: FormData) => {
    ...
    setSusccessfullysubmitted(result ? true : false);
  };
  return (
    <Page title="Ask a question">
      <form onSubmit={handleSubmit(submitForm)}>
        <Fieldset disabled={formState.isSubmitting || susccessfullysubmitted}>
          <FieldContainer>
